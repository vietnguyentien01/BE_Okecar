...
], StoreUpdateDto.prototype, "nameStore", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], StoreUpdateDto.prototype, "phoneStore", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], StoreUpdateDto.prototype, "addressStore", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => dto_1.ImageDto),
    __metadata("design:type", dto_1.ImageDto)
], StoreUpdateDto.prototype, "avatar", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => dto_1.ImageDto),
    __metadata("design:type", dto_1.ImageDto)
], StoreUpdateDto.prototype, "banner", void 0);
